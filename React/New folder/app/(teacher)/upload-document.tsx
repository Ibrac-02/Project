...
import { saveDocumentMetadata } from '../../lib/documents'; // Import the save metadata function
import { uploadDocument } from '../../lib/firebase'; // Import the upload function
    ...
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
      ...
      {selectedDocument && (
        <View style={{ marginTop: 20, alignItems: 'center' }}>
          ...
          <Text>Size: {(selectedDocument.size / 1024).toFixed(2)} KB</Text>
          <Button
