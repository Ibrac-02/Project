    ...
    const handleSaveAttendance = async () => {
        ...
        try {
            ...
            if (currentAttendanceRecord) {
                await updateAttendanceRecord(currentAttendanceRecord.id, {
                    ...commonData,
                    isApproved: currentAttendanceRecord.isApproved
                });
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                                ...
                                {record ? (
                                    <>
                                        ...
                                        {!record.isApproved && record.teacherId === user?.uid && (
                                            <TouchableOpacity onPress={() => handleDeleteAttendance(record.id)}
                                                              style={styles.actionButton}>
                                    ...
                                    <TouchableOpacity onPress={() => handleMarkAttendance(student)}
                ...
                ListEmptyComponent={<Text style={styles.noDataText}>No students in this class or no class
                    selected.</Text>}
            />
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        <Text
                            style={styles.modalTitle}>{currentAttendanceRecord ? 'Edit Attendance' : 'Mark Attendance'}</Text>
