...
export default function EditUserScreen() {
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          const profile: UserProfile = {
            ...
            classesHandled: userData?.classesHandalled || null,
            ...
            parentContactNumber: userData?.parentContactNumber || null,
          ...
          setParentContactNumber(profile.parentContactNumber || '');
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {(role === 'teacher' || role === 'headteacher' || role === 'admin') && (
        <>
          <View style={styles.formGroup}>
