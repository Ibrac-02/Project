  ...
  return (
    <View style={styles.container}>
      <View style={styles.topBar}>
        ...
        <TouchableOpacity style={styles.addBtn} onPress={() => router.push({ pathname: '/(admin)/teachers/new' as any })}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.row}>
              ...
              <TouchableOpacity onPress={() => router.push({ pathname: '/(admin)/teachers/[id]', params: { id: item.uid } as any } as any)} style={styles.rowBtn}>
