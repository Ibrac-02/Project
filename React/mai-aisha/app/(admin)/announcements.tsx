...
export default function AdminAnnouncementsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Post school-wide updates</Text>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.row}>
          {(['school-wide', 'staff-only'] as const).map(s => (
...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 10, paddingVertical: 6, backgroundColor: '#fff', borderWidth: 1, borderColor: '#ddd', borderRadius: 16, marginRight: 8 },
