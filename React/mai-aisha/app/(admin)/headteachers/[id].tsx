...
export default function AdminHeadteacherEdit() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Edit Headteacher</Text>
      ...
      <View style={styles.formRow}>
        ...
        <TextInput value={department} onChangeText={setDepartment} placeholder="e.g. Academics" style={styles.input} />
      </View>
      <View style={styles.formRow}>
        <Text style={styles.label}>Title</Text>
        <TextInput value={title} onChangeText={setTitle} placeholder="Headteacher" style={styles.input} />
      </View>
